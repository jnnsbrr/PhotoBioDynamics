...
bb_poly = st_read(here::here("data","input","14biomes_shp",
...
grat_poly = st_read(here::here("data","input","14biomes_shp",
...
ne_ocean = st_read(here::here("data","input","14biomes_shp",
                              "ne_50m_ocean.shp")) %>% 
  st_as_sf() %>%
  st_transform(crs = "+proj=robin")
...
biomes = sf::st_read(here::here("data","input","14biomes_shp",
                                "14_biomes_poly.shp")) %>%
  st_as_sf() %>% 
...
cowplot::ggdraw(GPP_biomes) +
  draw_image(image = here::here("data", "input","14biomes_shp", 
                                "snowflake.svg"),
  ...
  draw_image(image = here::here("data", "input","14biomes_shp", "flower.svg"),
  ...
  draw_image(image = here::here("data", "input","14biomes_shp", "sun.svg"), 
