...
biomes = sf::st_read(here::here("data", "static",
                                "14_biomes_poly.shp")) %>%
  st_as_sf() %>% 
...
cowplot::ggdraw(GPP_biomes) +
  draw_image(image = here::here("data", "static", 
                                "snowflake.svg"),
  ...
  draw_image(image = here::here("data", "static", "flower.svg"),
  ...
  draw_image(image = here::here("data", "static", "sun.svg"), 
